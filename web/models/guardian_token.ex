defmodule Gt.GuardianDb do
  ...
  defmodule Token do
    ...
    def find_by_claims(claims) do
      ...
      Gt.Repo.get_by(Token, jti: jti, aud: aud)
    end
    ...
    def create!(claims, jwt) do
      ...
      Gt.Repo.insert cast(%Token{}, prepared_claims, [], [:jti, :typ, :aud, :iss, :sub, :exp, :jwt, :claims])
    end
    ...
    def purge_expired_tokens! do
      ...
      from(t in Token, where: t.exp < ^timestamp) |> Gt.Repo.delete_all
    end
  end
